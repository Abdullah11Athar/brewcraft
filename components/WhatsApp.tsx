...
export default function WhatsAppButton() {
  ...
  const phone = '12125550189';
  const message = 'Hi BrewCraft! I would like to place an order.';
      ...
      <AnimatePresence>
        {showTooltip && (
          <motion.div
            ...
            className="bg-[#1a1a1a] text-white text-xs px-3 py-2 rounded-xl shadow-lg border border-[#333] whitespace-nowrap"
          >
